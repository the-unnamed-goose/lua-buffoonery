...
CMDs[#CMDs + 1] = { NAME = "loopswim", DESC = "Allows you to swim in the air upon respawning" }
CMDs[#CMDs + 1] = { NAME = "unloopswim", DESC = "Stops you from swimming everywhere upon respawning" }
CMDs[#CMDs + 1] = { NAME = "", DESC = "" }
...
addcmd("swim", {}, function(args, speaker)
	if not swimming and speaker and speaker.Character and speaker.Character:FindFirstChildWhichIsA("Humanoid") then
		...
		workspace.Gravity = 0
		local swimReset = function()
			execCmd("unswim")
		end
		local Humanoid = speaker.Character:FindFirstChildWhichIsA("Humanoid")
		gravDie = Humanoid.Died:Connect(swimReset)
		gravAdd = speaker.CharacterAdded:Connect(swimReset)
...
local loopswim = nil
addcmd("loopswim", {}, function(args, speaker)
	loopswim = RunService.Heartbeat:Connect(function()
...
addcmd("unloopswim", {}, function(args, speaker)
	if loopswim then
		loopswim:Disconnect()
		loopswim = nil
	end
